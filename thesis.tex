...
\begin{spacing}{1}
\chapter*{Beitragsübersicht}
\addcontentsline{toc}{chapter}{Beitragsübersicht}
\end{spacing}
...
% Verhindert Leerseiten vor Kapiteln im hinteren Dokumentteil (Glossar/Literatur/Verzeichnisse)
