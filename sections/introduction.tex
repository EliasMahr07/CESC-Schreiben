...
Ein besonderer Fokus dieser Arbeit liegt auf der Sicherheit. Das System überwacht den Türzustand der Container und speichert jede Türöffnung mit einem Zeitstempel. Dadurch kann nachvollzogen werden, wann und wie oft ein Container geöffnet wurde, insbesondere auch außerhalb der Arbeitszeiten. Dieses Protokoll trägt zur besseren Übersicht und Sicherheit auf der Baustelle bei.

\section{Zustandsdiagramm}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{pics/Events.png}
