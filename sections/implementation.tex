...
\section{Angular}
Da da Projekt nicht nur am Desktop bediehnt werden kann ist die ganze Applikation responsive gemacht. 
\setauthor{Elias Mahr}
...
\begin{figure}[H]
    ...
    \caption{Calender Editor Component}
    \label{fig:CalenderEditor}
\end{figure}
Die \texttt{calender-editor} Componente ist Teil des ``Kalender'' Elements der \texttt{start-list-component}.
Als erstes sieht man sofort den Kalender, bei dem immer das aktuelle Monat ausgewählt ist. Im Kalender wird zwischen zwei Arten von Urlauben unterschieden.
...
Nach erfolgreicher Anmeldung wird der ``bearbeiten'' Button freigeschaltet und sie können Umgeändert werden.
...
Die Feiertage werden von einer API geladen.
