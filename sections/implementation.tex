...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{pics/Systhemarchitektur.png}
...
\begin{itemize}
  ...
  Links auf 1/4 der Breite sind alle Baustellen, mit ihrem in der Datenbank gespeicherten Namen, aufgelistet. Die ausgewählte Baustelle wird immer gelb mit Rahmen markiert, so auch wenn die Maus darüber Hovert. In diesem Fall wird das Element auch ein wenig eingerückt. Immer am Ende des Abteils ist das Kalenderelement. Dieses ist blau eingefärbt, damit man es gut von den Baustellen unterscheiden kann.
